  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-gray-100">
      <div className="container mx-auto px-4 py-10">
        <TopHero
          title1="For Buyers"
          title2="Empower Your Shopping"
          subtitle="Join AgroConnect to buy fresh produce directly from farmers, support local agriculture, and enjoy better prices."
        />
      </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <Title
              ...
              subtitle="We provide everything you need to buy fresh produce directly from farmers, ensuring quality, transparency, and better prices."
            />
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <Title
              ...
              subtitle="A simple and effective way to buy fresh produce from local farmers"
            />
          </motion.div>
      ...
      <section className="py-24 bg-gradient-to-br text-black rounded-md relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center max-w-4xl relative z-10">
          ...
          >
            <Title
              title="Ready to Buy Fresh Produce?"
              subtitle="Join AgroConnect today and start buying fresh produce directly
              from local farmers. Enjoy better prices, fresher produce, and
